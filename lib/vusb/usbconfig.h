 ...
 */
#define USB_CFG_VENDOR_NAME     'h', 't', 't', 'p', 's', ':', '/', '/', 'g', 'i', 't', 'h', 'u', 'b', \
                                '.', 'c', 'o', 'm', '/', '3', 'c', 'k', 'y', '/', 't', 'i', 'n', 'y', \
                                '-', 'h', 'i', 'd', '-', 'a', 'l', 's'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'L', 'i', 'g', 'h', 't', ' ', 'S', 'e', 'n', 's', 'o', 'r'
 ...
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH    316
